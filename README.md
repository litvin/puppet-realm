...
1. [Setup - The basics of getting started with realm](#setup)
    * [What realm affects](#what-realm-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with realm](#beginning-with-realm)
